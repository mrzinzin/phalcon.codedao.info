 ...
 * @property \izi\caching\Cache $cache The cache application component. Null if the component is not enabled.
...
abstract class Application extends Module
{
    ...
    /**
     * @var array list of installed Izi extensions. Each array element represents a single extension
    ...
    protected function bootstrap()
    {
        if ($this->extensions === null) {
            $file = Izi::getAlias('@vendor/izisoft/extensions.php');
        ...
        foreach ($this->extensions as $extension) {
            ...
            if (isset($extension['bootstrap'])) {
                ...
                if ($component instanceof BootstrapInterface) {
                    Izi::trace('Bootstrap with ' . get_class($component) . '::bootstrap()', __METHOD__);
                    $component->bootstrap($this);
                } else {
                    Izi::trace('Bootstrap with ' . get_class($component), __METHOD__);
                }
            }
        }
        ...
        foreach ($this->bootstrap as $class) {
            ...
            if (!isset($component)) {
                $component = Izi::createObject($class);
            }
    ...
    public function setBasePath($path)
    {
        ...
        Izi::setAlias('@app', $this->getBasePath());
    }
     ...
     * @return \izi\caching\Cache the cache application component. Null if the component is not enabled.
     */
    ...
    /**
     * Configures [[Izi::$container]] with the $config
     *
    ...
    {
        Izi::configure(Izi::$container, $config);
    }
}
