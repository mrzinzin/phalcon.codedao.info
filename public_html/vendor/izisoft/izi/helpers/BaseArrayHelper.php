...
class BaseArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \izi\helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \izi\helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \izi\helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \izi\helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \izi\helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \izi\helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = \izi\helpers\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
     ...
     * [[\izi\base\Application::charset]] will be used.
    ...
    {
        if ($charset === null) {
            $charset = Izi::$app ? Izi::$app->charset : 'UTF-8';
        }
        $d = [];
     ...
     * ];
     *
     * $result = \izi\helpers\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \izi\helpers\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \izi\helpers\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
